...
dependencies.append(.package(name: "FluentSQLiteDriver", url: "https://github.com/vapor/fluent-sqlite-driver.git", from: "4.0.0"))
...
targetDependencies.append(.byName(name: "FluentSQLiteDriver"))
