...
open class Connection: NSObject {
    ...
    public func connect(withUrl url: Url, cipher:P7Socket.CipherType = .ECDH_AES_256_SHA256, compression:P7Socket.Compression = .DEFLATE, checksum:P7Socket.Checksum = .SHA256) -> Bool {
        self.url    = url
